...
| **Online ansehen**             | Meldet sich bei Bedarf am Backend an und öffnet die React-Online-Ansicht im Browser (aktueller Monat und Mandant, JWT). Voraussetzung: Frontend läuft (`npm run dev` unter `Frontend/`).                                                                      |
